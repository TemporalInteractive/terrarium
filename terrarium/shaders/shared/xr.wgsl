...
fn XrCamera::raygen(xr_camera: XrCamera, id: vec2<u32>, resolution: vec2<u32>, view_index: u32) -> XrCameraRay {
    ...
    let direction: vec3<f32> = XrCamera::screen_to_world_space(xr_camera, pixel_center, resolution, view_index);
...
fn XrCamera::screen_to_world_space(xr_camera: XrCamera, screen_space: vec2<f32>, resolution: vec2<u32>, view_index: u32) -> vec3<f32> {
